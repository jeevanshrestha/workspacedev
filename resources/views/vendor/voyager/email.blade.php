                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar  fadeInRightBig">
                            ...
                            <button type="submit" class="btn btn-block login-button">
                             <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span>Sending Reset Link...</span>
                             <span class="signin"> Reset Password</span>
                         </button>
                           
                     </form> 
                        <br> <div class="form-group"><a href="/admin/login" class="btn btn-warning">Back To Login</a></div>
                 </div>
